...
API_ID = int(os.environ.get("API_ID", "23698677"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "001400def80e870e3eef60bb38d8b871")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "7958306357"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://vikrammishra9210_db_user:UWMwNO0M5sFslW4o@cluster0.ollhem3.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
